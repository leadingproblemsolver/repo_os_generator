---
    objective: Capture why for tool-calling.
...
Allowed tools execute through a controlled registry with audit results. This matters because support automation only creates value when it reduces customer effort without hiding risk.
