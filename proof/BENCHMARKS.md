---
    objective: Own benchmarks proof content.
...
Initial benchmark: deterministic support interaction with customer profile, memory recall, knowledge hit, ticket update, escalation decision, and evaluation score. Target: local run completes without network calls and produces grounded response with at least one citation.
